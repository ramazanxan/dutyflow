...
12. ✅ Дополнительно — очередь дежурных, шаблоны, доска, достижения, передача задачи

Сознательно не делается: мобильные приложения, платная подписка, AI,
интеграции с Telegram и WhatsApp, письма на почту, полноценный офлайн.
